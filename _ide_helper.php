...
namespace {
	...
	class Social extends \Codesleeve\Social\Social{
		/**
		 ...
		 * @static 
		 */
		 public static function __construct($config, $url){
			//Method inherited from \Codesleeve\Social\SocialRepository
			 \Codesleeve\Social\SocialRepository::__construct($config, $url);
		 }
		 ...
		 * @static 
		 */
		 public static function login($serviceName){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::login($serviceName);
		 }
		 ...
		 * @static 
		 */
		 public static function check($serviceName){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::check($serviceName);
		 }
		 ...
		 * @static 
		 */
		 public static function facebook($request = ''){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::facebook($request);
		 }
		 ...
		 * @static 
		 */
		 public static function twitter($request = ''){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::twitter($request);
		 }
		 ...
		 * @static 
		 */
		 public static function google($request = ''){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::google($request);
		 }
		 ...
		 */
		 public static function github($request = ''){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::github($request);
		 }
		 ...
		 * @static 
		 */
		 public static function getDecoder($data){
			//Method inherited from \Codesleeve\Social\SocialRepository
			return \Codesleeve\Social\SocialRepository::getDecoder($data);
		 }
		 ...
		 * @static 
		 */
		 public static function setDecoder($json_closure = null){
			//Method inherited from \Codesleeve\Social\SocialRepository
			 \Codesleeve\Social\SocialRepository::setDecoder($json_closure);
		 }
		 ...
		 */
		 public static function setHttpClient($httpClient){
			...
			return \Codesleeve\Social\SocialRepository::setHttpClient($httpClient);
		 }
		 ...
		 */
		 public static function registerService($serviceName, $className){
			//Method inherited from \OAuth\ServiceFactory
			return \Codesleeve\Social\SocialRepository::registerService($serviceName, $className);
		 }
		 ...
		 */
		 public static function createService($serviceName, $credentials, $storage, $scopes = array(), $baseApiUri = null){
			//Method inherited from \OAuth\ServiceFactory
			return \Codesleeve\Social\SocialRepository::createService($serviceName, $credentials, $storage, $scopes, $baseApiUri);
		 }

	}
	class Authority extends \Authority\AuthorityL4\Facades\Authority{
		/**
